...
import Image from "../../app/contact/Image"

const ContactPage: React.FC = () => {
  const [state, handleSubmit] = useForm("xlddqjgn"); // Replace with your Formspree form ID
            ...
            <div className="flex gap-5 max-md:flex-col">
              ...
              <div className="flex flex-col ml-5 w-[62%] max-md:ml-0 max-md:w-full">
                <form
                  ...
                  className="flex flex-col grow items-start pt-28 pr-8 pb-16 pl-20 w-full text-base text-black bg-white max-md:px-5 max-md:pt-24 max-md:mt-8 max-md:max-w-full"
                >
                  ...
                  <textarea
                    ...
                    name="message"
                    required
                    className="self-stretch px-8 pt-7 pb-16 mt-6 bg-white rounded-xl border border-solid border-neutral-400 text-neutral-400 max-md:px-5 max-md:max-w-full"
                  ...
                  {state.succeeded && (
                    <div className="mt-4 p-4 text-white bg-green-500 rounded-lg w-full text-center">
